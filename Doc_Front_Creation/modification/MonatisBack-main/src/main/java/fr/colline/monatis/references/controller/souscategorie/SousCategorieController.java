...
// Pourquoi : exposer POST /monatis/references/souscategorie/page.
...
// Modification : endpoint page pour les sous-categories.
// Pourquoi : la page References > Sous-categories peut chercher et paginer sans charger toutes les sous-categories.
...
public ReferencePageResponseDto paginerReferences(
	...
	Page<SousCategorie> page = sousCategorieService.rechercherPage(
			recherche,
			PageRequest.of(
	...
	return ReferencePageResponseDtoMapper.mapperPageToResponseDto(
			page,
			SousCategorieResponseDtoMapper::mapperModelToBasicResponseDto);
}

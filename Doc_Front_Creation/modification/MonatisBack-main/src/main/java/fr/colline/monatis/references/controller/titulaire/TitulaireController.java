...
// Pourquoi : exposer POST /monatis/references/titulaire/page.
...
// Modification : endpoint page pour les titulaires.
// Pourquoi : la page References > Titulaires peut chercher et paginer sans charger tous les titulaires.
...
public ReferencePageResponseDto paginerReferences(
	...
	Page<Titulaire> page = titulaireService.rechercherPage(
			recherche,
			PageRequest.of(
	...
	return ReferencePageResponseDtoMapper.mapperPageToResponseDto(
			page,
			TitulaireResponseDtoMapper::mapperModelToBasicResponseDto);
}

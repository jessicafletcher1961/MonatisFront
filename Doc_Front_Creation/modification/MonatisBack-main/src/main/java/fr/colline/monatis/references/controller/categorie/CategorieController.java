...
// Pourquoi : exposer POST /monatis/references/categorie/page.
...
// Modification : endpoint page pour les categories.
// Pourquoi : la page References > Categories peut chercher et paginer sans charger toutes les categories.
...
public ReferencePageResponseDto paginerReferences(
	...
	Page<Categorie> page = categorieService.rechercherPage(
			recherche,
			PageRequest.of(
	...
	return ReferencePageResponseDtoMapper.mapperPageToResponseDto(
			page,
			CategorieResponseDtoMapper::mapperModelToBasicResponseDto);
}
